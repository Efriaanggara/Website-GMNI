    ...
    <div class="container">
        <div class="row py-4">
            <div class="col-lg-6 mx-auto text-center">
                <h1 class="fw-bolder text-light">VISI & MISI <p class="fw-medium">
                DPC GMNI OKU
                </p></h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                        <li class="breadcrumb-item"><a href="index.php" class="no-decoration text-light">Home</a></li>
                        <li class="breadcrumb-item active text-light" aria-current="page">Visi & Misi</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<!-- Hero Buka -->
    ...
    <div class="row">
        ...
        <div class="mb-5 d-flex">
            <h3 class="fw-bold me-4 text-danger">VISI</h3>
            <p class="text-justify">
            Visi Gerakan Mahasiswa Nasional Indonesia (GMNI) adalah mewujudkan masyarakat sosialis Indonesia yang berlandaskan Pancasila dengan semangat nasionalisme, menjunjung tinggi persatuan bangsa, memperjuangkan keadilan sosial, serta mengutamakan nilai-nilai ketuhanan yang berakar pada budaya bangsa.
            </p>
        </div>

        <!-- MISI -->
        <div class="d-flex">
            <h3 class="fw-bold me-4 text-danger">MISI</h3>
            <p class="text-justify">
            Misi Gerakan Mahasiswa Nasional Indonesia (GMNI) adalah mengembangkan kader yang berideologi Marhaenisme dengan pemahaman mendalam terhadap nilai-nilai keadilan sosial, memperjuangkan hak-hak rakyat yang tertindas, mengawal penerapan nilai-nilai Pancasila dalam kehidupan berbangsa dan bernegara, serta mendorong persatuan bangsa melalui semangat sosio-nasionalisme. GMNI berkomitmen membangun gerakan mahasiswa yang kritis dan progresif dalam menghadapi ketidakadilan, serta melaksanakan pendidikan kader yang berbasis nasionalisme dan keberpihakan pada rakyat kecil demi terwujudnya masyarakat yang adil dan makmur.
            </p>
        </div>
        </div>
